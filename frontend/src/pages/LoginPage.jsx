  ...
  return (
    <div className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        >
          Log in to your LeadVerifyPro account
        </motion.p>
      </div>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="relative w-full rounded-lg bg-primary py-3 text-white font-semibold hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 disabled:opacity-70 disabled:cursor-not-allowed transition-colors"
          >
            {isLoading ? (
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-background px-2 text-text/70">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              type="button"
              className="inline-flex w-full justify-center rounded-lg border border-border/40 bg-background px-4 py-2 text-sm font-medium text-text shadow-sm hover:bg-primary/5"
            >
